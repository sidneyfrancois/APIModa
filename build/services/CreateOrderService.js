...
var CreateOrderService = /** @class */ (function () {
    ...
    CreateOrderService.prototype.execute = function (_a) {
        var produto_name = _a.produto_name, preco_unidade = _a.preco_unidade, quantidade = _a.quantidade;
        return __awaiter(this, void 0, void 0, function () {
            var repository, valor_total, order;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        repository = (0, typeorm_1.getRepository)(Order_1.Order);
